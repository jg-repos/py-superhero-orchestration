...
resource "databricks_storage_credential" "this" {
  ...
  aws_iam_role {
    role_arn = var.databricks_metastore_cross_account_policy_arn
  }
}
...
resource "databricks_external_location" "this" {
  ...
  url             = "s3://${var.databricks_metastore_bucket_id}/metastore" #Same as databricks_metastore storage_root parameter
